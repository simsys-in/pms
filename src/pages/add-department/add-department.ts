...
httpOptions={headers:new HttpHeaders({
  ...
  ionViewWillEnter() {
this.f.department=this.navParams.get( "department");
 this.f.id=this.navParams.get("id")
  ...
  createDept() {
    if(this.f.department==null)this.referenceService.basicAlert("Department",'Enter the department');
    this.http.post<any>(config.apiUrl+"payroll/department",this.f,this.httpOptions).subscribe(res=>{
       console.log(res);
       if(res.status==true){
      ...
      this.referenceService.basicAlert("Department",'department field could not be Empty');
    }
  ...
  update(id){
    ...
    this.http.put(config.apiUrl+"payroll/department/"+id,this.f,this.httpOptions).subscribe(res=>{
      console.log(res);
...
delete(id){
  ...
  this.http.delete(config.apiUrl+"payroll/department/"+id,this.httpOptions).subscribe(res=>{
    console.log(res)
    if(res["success"]==true){
      let toast = this.tostr.create({
