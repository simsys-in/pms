...
export class AddBranchPage {
  ...
  this.branchIfo=this.navParams.get('branch');
...
httpOptions={headers:new HttpHeaders({
  ...
  ionViewWillEnter() 
  {
    if(this.branchIfo!=null){
      this.f.branch=this.branchIfo.branch;
      this.f.id=this.branchIfo.id;
    }
 ...
 //   alert('i am going to leave')
  ...
  createBranch() {
    if(this.f.branch==null)this.referenceService.basicAlert("Branch",'Enter the branch');
    this.http.post<any>(config.apiUrl+"payroll/branch",this.f,this.httpOptions).subscribe(res=>{
       console.log(res);
       if(res.status==true){
  ...
  update(id){
    ...
    this.http.put(config.apiUrl+"payroll/branch/"+id,this.f,this.httpOptions).subscribe(res=>{
...
delete(id){
  ...
  this.http.delete(config.apiUrl+"payroll/branch/"+id,this.httpOptions).subscribe(res=>{
